...
templates['teacher'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.section : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "                <li id=\"list_"
  ...
  return "                  <b><em>"
    + container.escapeExpression(((helper = (helper = helpers.section || (depth0 != null ? depth0.section : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"section","hash":{},"data":data}) : helper)))
    + "</em></b>\n";
